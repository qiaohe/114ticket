...
- (id)initWithPData:(NSDictionary*)data
{
    ...
    if (self) {
        ...
        NSArray *subArray = [TrainOrderDetail getDataSourceWithPData:[data objectForKey:@"trainOrderDetails"]];
        
        if (subArray) {
            self.trainOrderDetails = [NSMutableArray arrayWithArray:subArray];
        }
