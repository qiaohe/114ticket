...
+ (NSArray*)getDataSourceWithPData:(NSArray*)data
{
    NSMutableArray *dataSource = [NSMutableArray array];
    for (NSDictionary *subData in data) {
        TrainOrderDetail *detail = [[[TrainOrderDetail alloc]initWithPData:subData]autorelease];
