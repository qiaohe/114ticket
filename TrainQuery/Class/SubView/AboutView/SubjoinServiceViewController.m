...
- (void)initView
{
    ...
    selectImageView = [[UIImageView alloc]initWithFrame:CGRectMake(backImage.frame.origin.x + 5, backImage.frame.origin.y + 5, 30, 28)];
...
- (void)initView
{
    ...
    [rightBtn setTitle:@"服务说明" forState:UIControlStateNormal];
...
{
    InsureDetailViewController *insureDetailView = [[[InsureDetailViewController alloc]init]autorelease];
    [self pushViewController:insureDetailView completion:^{
        [insureDetailView getInsureDescription];
    }];
}
