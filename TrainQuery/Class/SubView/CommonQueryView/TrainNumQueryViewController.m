...
- (void)pressSearchBtn:(UIButton*)sender
{
    if ([Utils textIsEmpty:self.trainCode.text]) {
        ...
        QueryHistory *history = [[[QueryHistory alloc]initWithStartCity:nil endCity:nil startDate:self.startDate.text trainCode:self.trainCode.text queryType:QueryTrainCodeAndPrice]autorelease];
