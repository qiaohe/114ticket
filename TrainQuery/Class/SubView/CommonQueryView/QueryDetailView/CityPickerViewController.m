    ...
    [UIView animateWithDuration:duration
                     animations:^{
                         if (self.navigationController) {
                             self.navigationController.view.frame = CGRectMake(0, 20 - 40, appFrame.size.width, appFrame.size.height);
                         }else
...
- (void)keyBoardHide:(CGRect)frame animationDuration:(NSTimeInterval)duration
{
    [UIView animateWithDuration:duration
                     animations:^{
                         if (self.navigationController) {
                             self.navigationController.view.frame = CGRectMake(0, 20, appFrame.size.width, appFrame.size.height);
                         }else
                             self.view.frame = CGRectMake(0, 0, appFrame.size.width, appFrame.size.height);
                     }
                     completion:^(BOOL finished){
