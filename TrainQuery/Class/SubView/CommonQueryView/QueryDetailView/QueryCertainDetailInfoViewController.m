...
- (void)setTrainInfoFrame
{
    ...
    UIImageView *arrowImage = [self getImageViewWithFrame:CGRectMake(startCityLabel.frame.origin.x + startCityLabel.frame.size.width + 5, startCityLabel.frame.size.height/2 + startCityLabel.frame.origin.y - 7, 70, 7) image:imageNameAndType(@"destinationarrow", @"png") highLightImage:nil backGroundColor:[UIColor clearColor]];
    [trainInfoImage addSubview:arrowImage];
    
    self.trainCodeLabel = [self getLabelWithFrame:CGRectMake(arrowImage.frame.origin.x, arrowImage.frame.origin.y - arrowImage.frame.size.height/2 - 10, arrowImage.frame.size.width, 15) textAlignment:NSTextAlignmentCenter backGroundColor:[UIColor clearColor] textColor:[self getColor:@"ff6c00"] title:nil font:[UIFont fontWithName:@"HelveticaNeue" size:17]];
    ...
    theTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, trainInfoImage.frame.origin.y + trainInfoImage.frame.size.height + 10, selfViewFrame.size.width, selfViewFrame.size.height - trainInfoImage.frame.origin.y - trainInfoImage.frame.size.height - 10)];
