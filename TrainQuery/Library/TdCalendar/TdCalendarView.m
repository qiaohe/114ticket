...
-(void)drawTopBarWords{
    ...
    SInt32 year = currentMonthDate.year;
	NSString *title_Month   = [[NSString alloc] initWithFormat:@"%ld年%d月",(long)year,currentMonthDate.month];
...
-(void)drawDateWords{
	...
	for(int i=1;i<dayCount+1;i++)
	{
		...
		[date drawAtPoint:CGPointMake(x*s_width+15,y*itemHeight+headHeight + 13) withFont:weekfont];
